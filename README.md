# <img src="https://img.icons8.com/fluency/48/snapchat.png" width="28"/> Snapchat iOS SSL Pinning Bypass

> A patched version of Snapchat for iOS with SSL/TLS certificate pinning disabled — enabling HTTPS traffic inspection for security research, reverse engineering, and mobile application analysis.

![Platform](https://img.shields.io/badge/Platform-iOS-black?style=flat-square&logo=apple)
![Version](https://img.shields.io/badge/Latest%20Patch-13.85.0-yellow?style=flat-square)
...
| Field | Details |
|---|---|
| 📦 Latest patched version | `13.85.0` |
| 📱 Platform | iOS |
...
4. **Launch** Snapchat and begin inspecting traffic.
...
|---|---|---|---|---|---|
| <img src="https://img.icons8.com/fluency/20/snapchat.png"/> Snapchat | `com.toyopagroup.picaboo` | `13.85.0` | IPA | 🟢 Bypassed | [⬇️ Download](https://github.com/reversionet/Snapchat-iOS-SSL-Pinning-Bypass/releases/download/v13.85/Snapchat13.85.ipa) |
